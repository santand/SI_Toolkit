...
print *,'This program will cconvert a map from the ring format to nested format'
print *,'The input should be in ascii format. For fits files first convert it    &
to ascii format with fits2d'
